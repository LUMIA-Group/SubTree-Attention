...
# random split 20 per class
python main.py --dataset cora --rand_split_class --metric acc --method pfgnn --lr 0.01 --weight_decay 1e-2 --hidden_channels 32 \
--K 10 --runs 1 --epochs 2000 --device 0 --dropout 0.3
