...
--weight_decay 5e-4 --hidden_channels 32 --K 10 --runs 1 --epochs 1000 --device 0

python main.py --dataset citeseer --rand_split --metric acc --method pfgnn --lr 0.001 --pe --pe_dim 3 \
--weight_decay 5e-3 --hidden_channels 32 --K 10 --runs 1 --epochs 1000 --device 0

python main.py --dataset deezer-europe --rand_split --metric rocauc --method pfgnn --lr 0.001 --pe --pe_dim 3 \
--weight_decay  5e-3 --hidden_channels 32 --K 5 --runs 1 --epochs 1000 --device 0
...
--weight_decay 1e-3 --dropout 0.5  --hidden_channels 128 --K 10 --runs 1 --epochs 1000 --device 0

python main.py --dataset deezer-europe --rand_split --metric rocauc --method pfgnn --lr 0.001 --num_heads 8 --ind_gamma --gamma_softmax --pe --pe_dim 5 \
--weight_decay 5e-3 --hidden_channels 128 --K 5 --runs 1 --epochs 1000 --device 0 
